...
def main_process(groupID1, groupID2, trial, run_name):
    ...
    Parameters:
    groupID1 (int): The id of the group to run
    groupID2 (int): The id of the group to run
    trial (int): Trial #
    ...
    # This processing is now done locally - broken on savio for some reason
    # tfig = reader.traceplot(res)
    # tfig.savefig(prospector_plots_dir + f'/{run_name}_plots' + f'/{groupID}_trial{trial}_tfig.pdf')
