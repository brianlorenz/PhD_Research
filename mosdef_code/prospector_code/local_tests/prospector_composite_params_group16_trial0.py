...
# "%run prospector_dynesty.py --param_file='prospector_composite_params_group4_trial0.py' --outfile='/global/scratch/users/brianlorenz/prospector_h5s/nonpar_sfh_fixedbins_h5s/group2_trial19'"
