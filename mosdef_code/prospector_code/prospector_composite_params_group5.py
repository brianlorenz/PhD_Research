...
# %run prospector_dynesty.py --param_file='prospector_composite_params_group5.py' --outfile='/Users/brianlorenz/mosdef/Clustering/prospector_outputs/prospector_h5s/removed_kewley_agn_h5s/composite_group5'
