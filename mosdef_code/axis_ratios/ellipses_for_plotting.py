...
def get_ellipse_shapes(x_axis_len, y_axis_len, shape, scale_factor=0.035, shape_with_axis=False, axis_ratio=0):
    ...
    shape_with_axis (boolean): Set to true to st the shape of the ellipse to its axis ratio
    axis_ratio (float): If shape_with_axis is true, this is the value that will be used to set the ellipticity
    '''
    ...
    if shape_with_axis == True:
        ellipse_frac = axis_ratio
