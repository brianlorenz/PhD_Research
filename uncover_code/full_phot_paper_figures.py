...
def plot_paper_sample_select(show_hexes=True, show_point_color=False):
    ...
    fig.savefig(f'/Users/brianlorenz/uncover/Figures/PHOT_paper/sample_select{save_str}{save_str2}.pdf')
    scale_aspect(ax)
    plt.close('all')
