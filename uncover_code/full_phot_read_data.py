...
def read_ha_sample(axisratios=False):
    if axisratios:
        axisratio_str = '_axisratios'
    else:
        axisratio_str = ''
    sample_df = ascii.read(f'/Users/brianlorenz/uncover/Data/generated_tables/paper_data/ha_snr_sample{axisratio_str}.csv').to_pandas()
