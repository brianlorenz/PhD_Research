...
emission_fit_dir = '/Users/brianlorenz/uncover/Data/emission_fitting_he1_only/'
...
def fit_emission_uncover(spectrum, save_name, bootstrap_num=-1):
    ...
    pab_idx = [idx for idx, name in enumerate(line_names) if name == 'He1'][0]
