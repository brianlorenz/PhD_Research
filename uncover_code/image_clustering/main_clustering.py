...
def main(id_dr3_list, snr_thresh=3, cluster_method='test', norm_method=''):
    # prepare_images(id_dr3_list, snr_thresh=snr_thresh)
    # plot_cutout_overview(id_dr3_list)
    cluster_pixels(id_dr3_list, cluster_method=cluster_method, norm_method=norm_method)
    plot_cluster_summary(id_dr3_list, cluster_method=cluster_method, norm_method=norm_method)
